...
const FeatureHighlight = () => {
  return (
    <div className="w-full md:flex items-center bg-[#9399F4] py-5 text-center md:py-3 md:text-left md:min-h-[55vh]">
      ...
      <div className="md:w-[50%]">
        <h2 className="font-clashDisplay uppercase text-cyber-ink text-3xl md:text-5xl mx-auto mb-2 md:text-left text-white">
          CREATE
        </h2>
        <br />
